...
This post is an edited conversation between Steve Tooke, Aslak Hellesøy and Matt Wynne on The Cucumber Podcast. 
...
*Quick sales pitch. You can learn more about how we support large teams implementing BDD and Cucumber via [in-house training and consulting](https://cucumber.io/training). If you'd like one of the guys from the podcast to visit your offices, [contact us](https://cucumber.typeform.com/to/gUEP2E?source=blog) for more details.*
